...
- [Python](https://www.python.org/downloads/release/python-3106/) - During the Python installation, you'll see a note asking if you’d like to add Python to your PCs PATH. You do.
