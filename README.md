...
# A Moron's Guide to Voly's Stable Diffusion GUI
...
- [Python](https://www.python.org/downloads/release/python-3106/) - At the end of the Python installation you will see a note asking if you’d like to add Python to your PCs PATH. You do.
